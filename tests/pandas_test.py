...
try:
    ...
    PANDAS_EXPRESSIONS = OrderedDict((
                     ...
                     (b'2000.01.04T05:36:57.600 0Nz',                 {'data': pd.Series(np.array([np.datetime64('2000-01-04T05:36:57.600Z', 'ms'), np.datetime64('nat', 'ms')])),
                     ...
                     (b'2000.01.04D05:36:57.600 0Np',                 {'data': pd.Series(np.array([np.datetime64('2000-01-04T05:36:57.600Z', 'ns'), np.datetime64('nat', 'ns')])),
    ...
    def arrays_equal(left, right):
        ...
        if type(left) in [np.ndarray, pd.Series] and left.dtype.type != right.dtype.type:
